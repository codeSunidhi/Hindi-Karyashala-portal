...
<p>View and manage workshop details.</p>
...
echo htmlspecialchars($employee["attendance_date"]);
...
echo htmlspecialchars($employee["remarks"]);
...
<a
href="update_workshop.php?ic=<?php echo $employee["ic_number"]; ?>"
class="edit-btn"
